...
def bootstrap_test(yn, xn, setup_test, trials):
    ll1, grad1, hess1, ll2, params1, grad2, hess2, params2 = setup_test(yn, xn)
    nobs = ll1.shape[0]
    test_stats = []
    variance_stats = []
    ...
    cv_lower = np.percentile(test_stats/variance_stats, 2.5, axis=0)
    cv_upper = np.percentile(test_stats/variance_stats, 97.5, axis=0)
